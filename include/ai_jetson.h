...
namespace ai {
  class jetson  {
      public:
        ...
        // Set localizer position to send to Jetson (in cm and degrees)
        void       set_localizer_position(float x_cm, float y_cm, float heading_deg);
      ...
      private:
        ...
        // Localizer position to send to Jetson
        vex::mutex    poslock;
        float         localizer_x_cm;
        float         localizer_y_cm;
        float         localizer_heading_deg;
    };
};
